    ...
    <div style={{ minHeight: '100vh', background: BG, display: 'flex', alignItems: 'center', justifyContent: 'center', fontFamily: "'Inter', system-ui, sans-serif", padding: 24 }}>
      <div style={{ width: '100%', maxWidth: 420 }}>
        <div style={{ textAlign: 'center', marginBottom: 40 }}>
          ...
          <h1 style={{ fontFamily: "'Source Serif 4', Georgia, serif", fontSize: 28, fontWeight: 700, color: INK, margin: 0 }}>Finance Tracker</h1>
          <p style={{ color: MUTED, fontSize: 14, marginTop: 8 }}>Your personal net worth & cash flow dashboard</p>
        </div>
